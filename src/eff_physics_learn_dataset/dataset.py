    ...
    def parametric_splits(
        ...
        *,
        ...
        cfg = ParametricSplitConfig(
            ...
            solution_n_components=solution_n_components,
            solution_slice_axis=solution_slice_axis,
            solution_slice_index=solution_slice_index,
            diversify=diversify,
            diversify_pool_mult=diversify_pool_mult,
        )
        idx_splits = compute_parametric_splits(
            u=self.u,
            params=self.params,
        ...
        return {
            "train_few": self.select(idx_splits["train_few"]),
            "interp": self.select(idx_splits["interp"]),
            "extrap": self.select(idx_splits["extrap"]),
        }
